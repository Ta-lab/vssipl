                ...
                <form action="{{route('rmdcreceive.store')}}" id="sf_receive_formdata" method="POST">
                    ...
                    @method('POST')
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="new_rc_no">Route Card Number *</label>
                                    <input type="text" name="new_rc_no" id="new_rc_no" value="{{$new_rcnumber}}"  class="form-control bg-light @error('new_rc_no') is-invalid @enderror" @readonly(true)>
                                    @error('new_rc_no')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="receive_kg">Receive Quantity In KGS*</label>
                                    <input type="number" name="receive_kg" id="receive_kg" required min="0" class="form-control bg-light @error('receive_kg') is-invalid @enderror" readonly>
                                    @error('receive_kg')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
...
$(document).ready(function(){
    ...
    $('#receive_qty').change(function (e) {
        ...
        if (avl_qty!=''&&receive_qty!='') {
                ...
                // alert(diff);
                var kgs=receive_qty*bom_kg;
                var receive_kg= Math.round(kgs);
                $('#receive_kg').val(receive_kg);
                if(diff==0){
                    $('#inlineRadio1').show();
                }else{
                    $('#inlineRadio1').hide();
