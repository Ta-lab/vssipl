...
@endpush
@section('content')
<form action="{{route('ptsproductionissue.store')}}" id="pts_receive_formdata" method="POST">
    @csrf
    @method('POST')
...
<div class="row d-flex justify-content-center">
    ...
    @endif
        ...
        <div class="card">
            <div class="card-header d-flex" style="justify-content:space-between"><span> <b>PTS Store Material Issue To Pts Production Register</b></span><a class="btn btn-sm btn-primary" href="{{route('ptsproductionissue')}}">PTS Store Material Issue To Pts Production List</a>
            </div>
            <div class="card-body">
                        <div class="row d-flex justify-content-center">
                            <div class="col-md-3">
...
$(document).ready(function(){
    ...
    $('#rc_no').change(function (e) {
        ...
        if (rc_no!='') {
            $.ajax({
            type: "POST",
            url: "{{ route('ptsproductionpartissuefetchdata') }}",
            data:{
                "_token": "{{ csrf_token()}}",
                "rc_no":rc_no,
            },
