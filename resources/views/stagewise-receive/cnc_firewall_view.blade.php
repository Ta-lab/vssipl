...
<div class="row d-flex justify-content-center">
    ...
    @endif
        <div class="card">
            <div class="card-header d-flex" style="justify-content:space-between"><span><b>CNC Production Coverwise Assign List</b>  </span>
                <a class="btn btn-md btn-info text-white" href="{{route('cncproductionfirewallreceive')}}"><b><i class='bx bx-plus bx-flashing' style='color:white;' ></i>&nbsp;&nbsp; Inspection Register</b></a>
                <a class="btn btn-md btn-primary" href="{{route('cncproductioncoverwisecreate')}}"><b><i class='bx bx-plus bx-flashing' style='color:white;' ></i>&nbsp;&nbsp; New</b></a>
            </div>
            <div class="card-body">
                <div class="table">
