...
<div class="row d-flex justify-content-center">
    ...
    @endif
        ...
        <div class="card">
            <div class="card-header d-flex" style="justify-content:space-between"><span> <b>PTS Store Material Issue To CLE Inspection Register</b></span><a class="btn btn-sm btn-primary" href="{{route('ptscleissue')}}">PTS Store Material Issue To Pts Production List</a>
            </div>
            <div class="card-body">
...
$(document).ready(function(){
    ...
    $('#part_id').change(function (e) {
        ...
        if (part_id!='') {
            $.ajax({
                type: "POST",
                url: "{{ route('ptsclercreceivefetchdata') }}",
                data:{
                    "_token": "{{ csrf_token()}}",
                    "part_id":part_id,
                },
    ...
    $('#rc_no').change(function (e) {
        ...
        if (rc_no!='') {
            $.ajax({
            type: "POST",
            url: "{{ route('ptsclepartissuefetchdata') }}",
            data:{
                "_token": "{{ csrf_token()}}",
                "rc_no":rc_no,
                "part_id":part_id,
