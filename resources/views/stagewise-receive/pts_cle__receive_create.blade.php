...
<div class="row d-flex justify-content-center">
    ...
    @endif
        ...
        <div class="card">
            <div class="card-header d-flex" style="justify-content:space-between"><span> <b>PTS Store Material Receive From CLE Inspection Register</b></span><a class="btn btn-sm btn-primary" href="{{route('ptsclereceive')}}">PTS Store Material Receive From CLE Inspection List</a>
            </div>
            <div class="card-body">
                <div class="row d-flex justify-content-center">
                    <div class="col-md-3">
...
$(document).ready(function(){
    ...
    $('#part_id').change(function (e) {
        ...
        if (part_id!='') {
            $.ajax({
                type: "POST",
                url: "{{ route('ptsclercissuefetchdata') }}",
                data:{
                    "_token": "{{ csrf_token()}}",
                    "part_id":part_id,
                },
    ...
    $('#rc_no').change(function (e) {
        ...
        if (rc_no!='') {
            $.ajax({
            type: "POST",
            url: "{{ route('ptsclepartreceivefetchdata') }}",
            data:{
                "_token": "{{ csrf_token()}}",
                "rc_no":rc_no,
                "part_id":part_id,
