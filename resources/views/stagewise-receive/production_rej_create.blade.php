...
<div class="row d-flex justify-content-center">
    ...
    @endif
        ...
        <div id="res"></div>
        <div class="card">
            <div class="card-header d-flex" style="justify-content:space-between"><span> <b>Production Rejection Register</b></span><a class="btn btn-sm btn-primary" href="{{route('productionrejectionlist')}}">Production Rejection List</a>
            </div>
            <div class="card-body">
                @if ($qrCodes_count!=0)
                <div class="row">
                ...
                @endif
                <form action="{{route('productionrejection.store')}}" id="sf_receive_formdata" method="POST">
                    @csrf
                    @method('POST')
                        <div class="row d-flex justify-content-center">
...
$(document).ready(function(){
    ...
    $('#scan_rc_id').change(function (e) {
        ...
        if (rc_no!='') {
            $.ajax({
                type: "POST",
                url: "{{ route('productionqrrcrejfetchdata') }}",
                data:{
                    "_token": "{{ csrf_token()}}",
                    "rc_no":rc_no,
                },
