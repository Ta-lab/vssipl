                        ...
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <textarea name="address1" id="address1" class="form-control @error('address1') is-invalid @enderror" id="" cols="20" rows="4"></textarea>
                                    @error('address1')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="state_code" id="state_code"  class="form-control @error('state_code') is-invalid @enderror" >
                                    @error('state_code')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
