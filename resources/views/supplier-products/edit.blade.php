                        ...
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="raw_material_id" id="raw_material_id" class="form-control raw_material_id @error('raw_material_id') is-invalid @enderror">
                                        <option value=""></option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="external_rm_desc" id="external_rm_desc" class="form-control @error('external_rm_desc') is-invalid @enderror" value="{{$supplierProduct->external_rm_desc}}" >
                        ...
                        <div class="row d-flex">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="products_hsnc" id="products_hsnc" value="{{$supplierProduct->products_hsnc}}" class="form-control @error('products_hsnc') is-invalid @enderror" >
                                    @error('products_hsnc')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
