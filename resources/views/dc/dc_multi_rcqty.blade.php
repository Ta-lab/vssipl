<input type="hidden" name="ino_qty" id="ino_qty" value="{{$t_avl_qty}}">
<span class="me-auto mb-3"><button class="btn btn-secondary text-white">STEP 2-Route Card Details</button></span>
<div class="col-md-12">
...
<div class="row mb-3 d-flex justify-content-end clearfix" style="background-color: aliceblue">
    ...
    <div class="col-2"><input type="number" name="grand_total[{{$m_part_id}}]" class="form-control bg-light grand_total_{{$m_part_id}}" id="grand_total_{{$m_part_id}}" value="{{$t_avl_qty}}"  readonly>
    </div>

    <div class="col-2"><h6>Balance:</h6></div>
    <div class="col-2"><input type="number" name="total_diff[{{$m_part_id}}]" class="form-control bg-light total_diff_{{$m_part_id}}" id="total_diff_{{$m_part_id}}" value="0"  readonly></div>
