                        ...
                        <table class="table table-bordered table-striped table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr id="tr_{{$fqcData->id}}">
                                    ...
                                    <td><input type="number" class="form-control offer_qty bg-light" name="offer_qty[{{$fqcData->id}}]" readonly value="{{$fqcData->offer_qty}}" id="offer_qty"></td>
                                    <td><input type="number" class="form-control inspect_qty" name="inspect_qty[{{$fqcData->id}}]" min="0" max="{{$fqcData->offer_qty}}" value="{{$fqcData->offer_qty}}" id="inspect_qty" onpaste="return false;" onCopy="return false" onCut="return false" onDrag="return false" onDrop="return false"></td>
                                    <td>
