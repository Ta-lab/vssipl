...
<div class="row d-flex justify-content-center">
    ...
    <div class="col-12">
        <div class="card">
            ...
            @endif
            <form action="{{route('ptsdcmultipdf')}}" method="post" target="_blank">
                @csrf
                @method('POST')
                <div class="card-header d-flex" style="justify-content:space-between"><span> <b>Multi Delivery challan List</b> </span>
                    <a class="btn btn-sm btn-info text-white" href="{{route('ptsmultidccreate')}}">Multi DC Print</a>
                </div>
                <div class="card-body">
                    <div class="row d-flex justify-content-center">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="s_no" id="s_no" class="form-control s_no  @error('s_no') is-invalid @enderror">
                                    ...
                                    <option value="{{$dcprintData->s_no}}">{{'DC-U4-'.$dcprintData->s_no}}</option>
                                    @endforeach
                                </select>
                                @error('s_no')
