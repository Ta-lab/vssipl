...
@foreach ($dc_transactionDatas as $key => $dc_transactionData)
    ...
    <td><input type="number" name="received_qty[{{$dc_transactionData->dc_print_id}}]"  class="form-control bg-light received_qty" id="received_qty" value="{{$dc_transactionData->u2_dc_qty}}" maximum="{{$dc_transactionData->issue_qty}}" readonly></td>
    <td><input type="number" name="receive_qty[{{$dc_transactionData->dc_print_id}}]"  class="form-control receive_qty" id="receive_qty" value="{{($dc_transactionData->issue_qty)-($dc_transactionData->u2_dc_qty)}}" minimum="0" maximum="{{($dc_transactionData->issue_qty)-($dc_transactionData->u2_dc_qty)}}"></td>
