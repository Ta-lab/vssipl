    ...
    <div class="col-12">
        ...
        <div class="card">
            ...
            <form action="{{route('ptsdcmultidcstore')}}" method="post">
                ...
                @csrf
                @method('POST')
                <div class="card-header d-flex" style="justify-content:space-between"><span> <b>PTS Multi Delivery challan Material Handover Entry</b> </span>
                <a class="btn btn-sm btn-primary text-white" href="{{route('ptsmultidcreceive')}}">Material Inward</a>
                <a class="btn btn-sm btn-info text-white" href="{{route('ptsinwarddata')}}">PTS Multi Delivery challan Material Handover List</a>
                </div>
                <div class="card-body">
                    <div class="row d-flex justify-content-center">
                        <div class="col-md-3">
...
<script>
        ...
        $("#s_no").change(function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{route('ptsmultidchandoverdata')}}",
                data: {"s_no":s_no},
                success: function (response) {
                    if (response.production_msg) {
                        if (response.sno_msg) {
