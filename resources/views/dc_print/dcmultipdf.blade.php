                                    ...
                                    <table class="table table-bordered table-striped table-responsive">
                                        <tr>
                                          ...
                                          <tr>
                                              ...
                                              <td class="tg-baqh" style="text-align:center;font-size:10px;height: 28px;vertical-align:top">{{$dc_transactionDatas[$i]->issue_wt}}</td>
                                              <td class="tg-baqh" style="text-align:center;font-size:10px;height: 28px;vertical-align:top" colspan="6">{{$dc_transactionDatas[$i]->remarks}}</td>
                                          </tr>
                                          @endfor
                                            @if ($diff>0)
                                                @for ($x = $first; $x < (($diff)); $x++)
                                                    <tr >
                                                        ...
                                                        <td class="tg-baqh" style="text-align:center;font-size:10px;height: 28px;vertical-align:top"></td>
                                                        <td class="tg-baqh" style="text-align:center;font-size:10px;height: 28px;vertical-align:top"></td>
                                                        <td class="tg-baqh" style="text-align:center;font-size:10px;height: 28px;vertical-align:top" colspan="6"></td>
                                                    </tr>
                                                @endfor
                                                @else
                                            @endif
