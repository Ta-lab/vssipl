    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="row col-md-3"id="res"></div>
                ...
                <form action="{{route('raw_material_category.update',$rawMaterialCategory->id)}}" id="raw_material_category_formdata" method="POST">
                    @csrf
                    @method('PUT')
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    if (data.code==404||data.code==500) {
                        ...
                        swalWithBootstrapButtons.fire(
                            'Updated!',
                            'Raw Material Category is Updated Successfully!...',
                            'success'
                            );
