...
<div class="row d-flex justify-content-center">
    <div class="col-8 ">
        ...
        <div class="card-header d-flex justify-content-space-around">
            <div class="col-md-8">Create Stocking Point Rack Master</div>
            <div class="col-md-4"><a class="btn btn-sm btn-primary" href="{{route('rack-stockmaster.index')}}">Stocking Point Rack Master List</a></div>
        </div>
        <div class="row col-md-3"id="res"></div>

            <div class="card-body">
            <form action="{{route('rack-stockmaster.store')}}" id="rack-stockmaster_formdata" method="POST">
                @csrf
                @method('POST')
...
<script>
    $(document).ready(function(){
        ...
        $("#rack-stock-master_formdata").submit(function (e) {
            e.preventDefault();
