                        ...
                        <table class="table table-bordered table-striped table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$inward_data->rcmaster->rc_id}}</td>
                                    <td>{{$inward_data->grndate}}</td>
                                    <td>{{$inward_data->podata->rcmaster->rc_id}}</td>
                                    <td>{{$inward_data->podata->supplier->supplier_code}}</td>
                                    <td>{{$inward_data->podata->supplier->name}}</td>
                                    <td>{{$inward_data->rmmaster->category->name}}</td>
                                    <td>{{$inward_data->rmmaster->name}}</td>
