                    ...
                    <div class="table-responsive mt-1 mx-1">
                        <table class="table table-bordered border-dark" style="line-height: 1;">
                            ...
                            <tr>
                                ...
                                <td colspan="3"><b>RM.T.C Number</b></td>
                            ...
                            <tr>
                                ...
                                <td colspan="5">{{$d12Datas->grndata->poproduct->suppliers->name}}</td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="3"><b>{{$d12Datas->grndata->invoice_number}}</b></td>
                            ...
                            <tr>
                                ...
                                @if ($count>0)
                                <td colspan="4"><b>{{$rmRequistionGrnDetails->req_kg}}(Kgs) & {{$rmRequistionGrnDetails->req_qty}}(Nos)</b></td>
                                @else
                                <td colspan="4"></td>
                                @endif
                            ...
                            <tr>
                                ...
                                @if ($count>0)
                                <td colspan="4"><b>{{$rmRequistionGrnDetails->to_be_return_kg}}(Kgs) & {{$rmRequistionGrnDetails->to_be_return_qty}}(Nos)</b></td>
                                @else
                                <td colspan="4"></td>
                                @endif
                            </tr>
                            <tr>
                                ...
                                <td><b>Shift</b></td>
                                <td colspan="4"><b>Total Running Hours</b></td>
                            </tr>
                            <tr>
                                <td colspan="2"></td>
                                <td colspan="3"></td>
                            ...
                            <tr>
                                <td colspan="12"><b>MATERIAL PROCESS DETAILS</b></td>
                            </tr>
                            <tr>
                                <td><b>S.No</b></td>
                                <td><b>DATE</b></td>
                            ...
                            <tr>
                                <td colspan="5"><b>Total QTY</b></td>
                                <td><b>{{$nextd12Summaries->total_receive_qty}}</b></td>
                                <td><b>{{$nextd12Summaries->total_reject_qty}}</b></td>
                                <td><b>{{$nextd12Summaries->total_rework_qty}}</b></td>
                                <td><b>{{$nextd12Summaries->total_issue_qty}}</b></td>
                                <td colspan="3"></td>
                            ...
                            <tr>
                                <td colspan="6"><b>RM ISSUE QUANTITY</b></td>
                                @if ($count>0)
                                    <td  colspan="6"><b>{{$rmRequistionGrnDetails->issue_qty}}</b></td>
                                @else
                                    <td colspan="6"></td>
                                @endif
                            </tr>
                            <tr>
                                <td colspan="6"><b>RECEIVE QUANTITY</b></td>
                                @if ($count>0)
                                    <td  colspan="6"><b>{{$nextd12Summaries->total_receive_qty}}</b></td>
                                @else
                                    <td colspan="6"></td>
                                @endif
                            </tr>
                            <tr>
                                <td colspan="6"><b>REJECT QUANTITY</b></td>
                                @if ($count>0)
                                    <td  colspan="6"><b>{{$nextd12Summaries->total_reject_qty}}</b></td>
                                @else
                                    <td colspan="6"></td>
                                @endif
                            </tr>
                            <tr>
                                <td colspan="6"><b>REWORK QUANTITY</b></td>
                                @if ($count>0)
                                    <td  colspan="6"><b>{{$nextd12Summaries->total_rework_qty}}</b></td>
                                @else
                                    <td colspan="6"></td>
                                @endif
                            </tr>
                            <tr>
                                <td colspan="6"><b>REMAINING QUANTITY</b></td>
                                @if ($count>0)
                                    <td  colspan="6"><b>{{($rmRequistionGrnDetails->issue_qty)-(($nextd12Summaries->total_receive_qty)+($nextd12Summaries->total_reject_qty)+($nextd12Summaries->total_rework_qty))}}</b></td>
                                @else
                                    <td colspan="6"></td>
                                @endif
                            </tr>
